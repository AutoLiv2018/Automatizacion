...
public class CheckoutP0 {
    ...
    public String buscarNumeroEventoMRFL(MesaRegaloFL numEv) {
        ...
        Log.write("property     " + Cpaso0.getProperty(CheckoutPaso0.NUMEVENTORFL));
        ...
        buscaEvento(numEv);
            ...
            if ((element = Find.element(driver, Cpaso0.getProperty(CheckoutPaso0.LBL_BUSQ_ERROR))) != null) {
                ...
                if ((element = Find.element(driver, evento)) != null) {
                    ...
                    Utils.sleep(3000);
                    Log.write("elemento *******************" + Find.element(driver, Cpaso0.getProperty(CheckoutPaso0.VALIDA_NUM_EVENTO)));
...
//        }
    ...
    public boolean validaNumEvento(MesaRegaloFL numEv) {
        ...
        if ((element = Find.element(driver, Cpaso0.getProperty(CheckoutPaso0.VALIDA_NUM_EVENTO))) != null) {
            Log.write("res busqueda *********** " + Cpaso0.getProperty(CheckoutPaso0.VALIDA_NUM_EVENTO));
...
//                        select.selectByVisibleText(festejado.get(1).getText());
    ...
    public boolean botonPagar() {
        ...
        Log.write("---------boton pagar----" + ((Find.element(driver, Cpaso0.getProperty(CheckoutPaso0.BOTONPAGARMRFL))) != null));
