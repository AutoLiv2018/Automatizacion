/*
 * Propieties del Paso 1 (Direccion de entrega)
 */
 ...
 * @author aperezg03
 */
public class Checkout_Paso1 {
    public static final String PROPERTIES_FILE = "Paso1_Checkout.properties";
    ...
    public static final String NOMBREGUEST = "nombreGuest";
    public static final String APATERNOGUEST = "aPaternoGuest";
    public static final String AMATERNOGUEST = "aMaternoGuest";
    public static final String CORREOGUEST = "correoGuest";
    public static final String LADAGUEST = "ladaGuest";
    public static final String TELEFONOGUEST = "telefonoGuest";
